        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    {
                        $id = $_GET['id'];
                        $manage = getByID("tbl_management", $id);

                        if (mysqli_num_rows($manage) > 0) 
                        {
                            $data = mysqli_fetch_array($manage);
                    ?>
                            <div class="card-header">
                                <H1>Edit Service in <?= $data['description'] ?></H1>
                            </div>
                            <div class="card-body">
                                ...
                                <form action="../code.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group text-end">
                                        ...
                                        <button type="submit" name="update_management" class="btn btn-primary">Save</button>
                                    </div>
                                </form>
                            </div>
                    <?php
